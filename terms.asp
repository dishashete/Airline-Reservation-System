...
<body>
    <pre>
        ...
        The baggage allowance on given fare is as per the terms decided by the airline, and ibibo has no role to play in the same. Some of the fares shown in the booking flow are �hand baggage fares� which do not entitle the User for free check in baggage and therefore the User will be required to pay separately for check in baggage. The prices for adding check-in baggage to a booking may vary from airline to airline. The User is advised to contact the airlines for detailed costs.
        CODE SHARE
        ...
        In the event User does not embark on the onward journey, the entire PNR pertaining to that booking shall be automatically cancelled by the airline. In such a scenario ibibo has no control in the said process nor will be obligated to provide alternate bookings to the User. The cancellation penalty in such an event shall be as per the applicable airline rules.
        CHANGES TO EXISTING BOOKING

        Any changes that are made to any existing booking shall be subject to certain charges levied by the respective airline, apart from the service fee charged by ibibo.
        ...
        Refunds will be processed as per the airline fare rules and cancellation policy. Such refunds shall be subject to ibibo receiving the same from the airlines. However, the convenience fee paid to ibibo paid at the time of booking is a non-refundable fee.
        All cancellations made directly with the airline need to be intimated to ibibo, in order to initiate the process of refund. The processing time for refunds may vary depending on the mode of payment, bank etc. The refund shall be processed after deducting the ibibo service fee which is independent of the convenience fee as mentioned above.
        The refund will be credited to the same account from which the payment was made. For example, if the User used a credit card, ibibo will make an appropriate charge reversal to the same credit card; like-wise if the User used a debit card, ibibo will credit the money to the same debit card.
...
<pre>
        ...
        The User acknowledges that ibibo merely acts as a facilitator to enable the User to book a Charter. The contract of service is always between the User and the concerned Charter Company.
        The booking will be governed by terms decided by the Charter Company and the Charter Company reserves the right to cancel or reschedule the charter booked on account of events like bad weather conditions, lockdown, operational requirements or if there is any unforeseen technical/mechanical problem. An alternate charter is subject to availability and is the sole prerogative of the Charter Company of which ibibo has no control. Any difference in the fare will be payable basis the fare existing at time of rescheduling the charter flight.
        FACILITIES ON BOARD

        Carry �on luggage /Baggage allowance, boarding & lodging facilities, number of passenger , food etc. are as per the terms of the charter Company and ibibo has no role to play in the same. ibibo may facilitate the communication on the requests of the User to the Charter Company, however, fulfilment of those requests are entirely the prerogative of the Charter Company
        CHANGES IN EXISTING BOOKING
        ...
        User understands that the Charter Company requires passenger names, nationality, passport number, date of issue and date of expiry, medical reports etc. well in advance to obtain necessary security clearances and to undertake the travel .User also understands that inability to travel on account of not carrying valid travel documents or refusal to board shall be solely attributable to the User and ibibo shall in no way be held liable for the same.
        REFUND

        Refunds will be processed as per the Charter fare rules and cancellation policy. Such refunds shall be subject to ibibo receiving the same from the Charter Company. However, the convenience fee paid to ibibo paid at the time of booking is a non-refundable fee
        The refund will be credited to the same account from which the payment was made. For example, if the User used a credit card, ibibo will make an appropriate charge reversal to the same credit card; like-wise if the User used a debit card, ibibo will credit the money to the same debit card.
        </pre>
    ...
    <pre>
        ...
        ROLE OF ibibo AND LIMITATION OF LIABILITY OF ibibo

        ibibo acts as a facilitator and merely provides an online platform to the User to select and book a particular hotel. Hotels in this context includes all categories of accommodations such as hotels, home-stays, bed and breakfast stays, farm-houses and any other alternate accommodations.
        All the information pertaining to the hotel including the category of the hotel, images, room type, amenities and facilities available at the hotel are as per the information provided by the hotel to ibibo. This information is for reference only. Any discrepancy that may exist between the website pictures and actual settings of the hotel shall be raised by the User with the hotel directly, and shall be resolved between the User and hotel. ibibo will have no responsibility in that process of resolution, and shall not take any liability for such discrepancies.
        INFORMATION FROM THE HOTEL AND THE TERMS OF THE HOTEL

        The hotel booking voucher which ibibo issues to a User is solely based on the information provided or updated by the hotel regarding the inventory availability. In no circumstances can ibibo be held liable for failure on part of a hotel to accommodate the User with a confirmed booking, the standard of service or any insufficiency in the services, or any other service related issues at the hotel. The liability of ibibo in case of denial of check-in by a hotel for any reason what-so-ever including over-booking, system or technical errors, or unavailability of rooms etc., will be limited to either providing a similar alternate accommodation at the discretion of ibibo (subject to availability at that time), or refunding the booking amount (to the extent paid) to the User. Any other service related issues should be directly resolved by the User with the hotel.
        Hotels reserves the sole right of admission and ibibo has no say whatsoever in admission or denial for admission by the hotel. Unmarried or unrelated couples may not be allowed to check-in by some hotels as per their policies. Similarly, accommodation may be denied to guests posing as a couple if suitable proof of identification is not presented at the time check-in. Some hotels may also not allow local residents to check-in as guests. ibibo will not be responsible for any check-in denied by the hotel due to the aforesaid reasons or any other reason not under the control of ibibo. No refund would be applicable in case the hotel denies check-in under such circumstances.
        RESPONSIBILITIES OF THE USER

        The User would be liable to make good any damage(s) caused by any act of him/ her/ or their accompanying guests (willful/negligent) to the property of the hotel in any manner whatsoever. The extent and the amount of the damage so caused would be determined by the concerned hotel. ibibo would not, in any way, intervene in the same.
        ...
        2.4.2. Hotels may charge a mandatory meal surcharge on festive periods like Christmas, New Year's Eve or other festivals as decided by the hotel. All additional charges (including mandatory meal surcharges) need to be cleared directly at the hotel. ibibo will have no control over waiving the same.
        PAYMENT FOR BOOKINGS AND ANY ADDITIONAL PAYMENTS

        Booking of a hotel can either be �Prepaid�, or �Pay at hotel� as per the options made available by a hotel on the Website of ibibo.
        In �Prepaid� model, the total booking amount is paid by the User at the time of booking itself. Such total booking amount includes the hotel reservation rate, taxes, service fees as may be charged on behalf of the actual service provider, and any additional booking fee or convenience fee charged by ibibo.
        At the hotel�s or ibibo�s sole discretion on case to case basis, the User may also be provided with an option to make a part payment to ibibo at the time of confirmation of a booking. The balance booking amount shall be paid as per the terms of the bookings. For security purposes, the User must provide ibibo with correct credit or debit card details. ibibo may cancel the booking at its sole discretion in case such bank or credit card details as provided by the User are found incorrect.
        ...
        Some accommodation suppliers may require User and/or the other persons, on behalf of whom the booking is made, to present a credit card or cash deposit upon check-in to cover additional expenses that may be incurred during their stay. Such deposit is unrelated to any payment received by ibibo and solely at the behest of the Hotel.
        In �Pay at hotel� model, the concerned hotel will collect the entire payment against the booking at the time of check-in. In case of international bookings, the payment will be charged in local currency or in any other currency, as decided by the hotel. For security purposes, the User must provide ibibo with correct credit or debit card details. ibibo may cancel the booking at its sole discretion in case such bank or credit card details as provided by the User are found incorrect.
        PAYMENT FOR BOOKINGS AND ANY ADDITIONAL PAYMENTS

        The Website may contain links to third party websites. ibibo does not control such websites and is not responsible for its contents. If a User accesses any third-party website, the same shall be done entirely at the User�s risk and ibibo shall assume no liability for the same.
        ibibo is not responsible for any errors, omissions or representations on any of its pages, links or any linked website pages to the extent such information is updated or provided directly by the Service Providers or the advertisers.
        ibibo does not endorse any advertisers on its Website, or any linked sites in any manner. The Users are requested to verify the accuracy of all information provided on the third-party web pages.
        The linked sites are not under the control of ibibo and hence ibibo is not responsible for the contents of any linked site(s) or any further links on such site(s), or any changes or updates to such sites. ibibo is providing these links to the Users only as a convenience.
       </pre>
    <pre>
        <b>4. BUS</b>
        ...
        ibibo only provides a technology platform that connects intending travelers with bus operators. It doesn�t operate any bus or offer the service of transportation to the User. ibibo also doesn�t act as an agent of any bus operator in the process of providing the above-mentioned technology platform services.
        The bus ticket booking voucher which ibibo issues to a User is solely based on the information provided or updated by the bus operator regarding the seat availability.
        The amenities, services, routes, fares, schedule, bus type, seat availability and any other details pertaining to the bus service are provided by the respective bus operator and ibibo has no control over such information provided by the bus operator.
        LIMITATION OF LIABILITY OF ibibo

        In its role as a technology platform to facilitate transactions between the bus operators and the Users, ibibo shall not be responsible for the operations of the bus operator including, but not limited to the following:
        ...
        Bus operator informing a wrong boarding point for the issuance of the booking confirmation voucher, or changing such boarding point eventually with or without any notification to ibibo or the User;
        ...
        Cancellation of tickets can be done either through the User�s login in the ibibo�s website or mobile application, or by calling on the customer care number;
        Any cancellation is subject to such cancellation charges as mentioned on the ticket.</pre>
    <pre>
       <b> 5. CABS</b>
        ...
        TYPES OF CAB BOOKINGS FACILITATED BY ibibo

        Outstation Cab: This enables User(s) to book vehicles operated by cab operators having All India Tourist Permit (AITP) vehicles and operating between two separate cities. On the basis of the demand/requirement of the User, ibibo as a facilitator connects the User with the concerned cab operator.
        ...
        ROLE OF ibibo AND LIMITATION OF LIABILITY

        ibibo does not operate cab services on its own. In order to provide a comprehensive choice of cab services, cab types and prices to User, it has tied up with many Cab Operators.
        ibibo acts only acts a facilitator between the Cab Operator and User. The transaction is always between the Cab Operator and the User.
        ...
        ibibo will not be liable to User or to any other person for any direct, indirect, incidental, punitive or consequential loss, damage, cost or expense of any kind whatsoever and howsoever caused from out of the information derived by User through usage of Website, in so far as such information is provided by the Cab Operator.
        In case of break down or accident of Cab where Cab Operator has been unable to make alternative arrangement, ibibo shall provide proportionate refund to User for uncovered distance. Any claims, liabilities or legal costs arising out of such event shall be borne by the Cab Operator.
        PAYMENT FOR BOOKINGS AND ANY ADDITIONAL PAYMENTS

        Booking of a Cab can either be �Prepaid�, or �Part Payment� as per the options made available by the Cab operator on the Website of ibibo.
        In �Prepaid� model, the total booking amount is paid by the User at the time of booking itself. Such total booking amount includes the base fare, applicable taxes, service fees as may be charged on behalf of the Cab operator, and any additional booking fee or convenience fee charged by ibibo.
        ...
        Cab Operator is obligated to commence the trip as soon as the User boards the Cab. User shall report to ibibo in case the driver denies to commence the trip for any reason whatsoever.
        ...
        User shall be responsible and liable for their own safety and security of luggage. ibibo shall not be responsible for any loss to User or their luggage in any event.
        In the event of any dissatisfaction with any of the services provided by Cab Operator or ibibo, the matter must be reported directly to Cab Operator or ibibo, in order that appropriate action may be taken to remedy the problem.
        ...
        Catering Service is not available and catering charges are not included in the fare.
        blanket and linen shall be provided in the train.
        ...
        You must have read the health advisory issued by my destination state. You accept and shall abide by the same.
     
        To read other guidelines :
        ROLE OF ibibo

        ibibo only acts as a facilitator for booking of train tickets and provides intending travelers merely with a platform to search for desired train tickets to be booked through IRCTC. All bookings or train reservations made through ibibo are subject to the applicable Terms & Conditions as set out by Indian Railways.
        ibibo has no control over the booking flow, scheduling/re-scheduling, cancellations, confirmation from RAC to confirmed, delays, meal and berth preferences or any other lack or deficiency of services. Liability, if any, for the above-said stands against the Indian Railways.
        ...
        Train functionality on the Website will not be functional between 2345 hours to 0030 hours or as specified by IRCTC due to system downtime or any other reason beyond the control of ibibo.
        RESPONSIBILITIES OF THE USERS

        At the stage of booking of e-tickets, customers will be automatically diverted to www.irctc.co.in website/app to input their IRCTC login credentials. Passengers are required to remember their IRCTC user name and password in order to book trains on ibibo�s Site.
        E-tickets are booked and issued through Indian Railways only. Users can book a maximum of 6 seats/ berths in a booking. Seat/ berth allotment is done by Indian Railways based on their allocation logic. ibibo does not guarantee allotment of preferred seat/ berth.
        ...
        Please visit including www.irctc.co.in or for all relevant information/ queries pertaining to your bookings.
        PAYMENTS FOR BOOKINGS, AND CANCELLATIONS

        ibibo�s service charges are non-refundable
        Bookings can only be cancelled through the app or the website; offline cancellations are not permitted
        The bookings made on ibibo�s Site are subject to cancellation policy and charges levied by the Indian Railways. It may vary depending on the cancellation time and booking quota (tatkal/ general/ ladies/ premium etc.).
        Railways automatically cancel the fully waitlisted e-tickets after chart preparation. The refund in such cases gets automatically credited to your bank account used for booking such tickets after deduction of ibibo�s charges
        Railways may offer special concessions/ discounts for senior citizens, female passengers and children. The amount or extent of concession is not decided by ibibo. All customers are advised to check latest railways policies for applicable discounts.
        </pre>

        <pre>
        <b>7. ACTIVITIES AND OTHER SERVICES</b>
        ...
        ibibo�s role is limited to facilitating the procurement of an Activity service by the User from the Activity Provider. The transaction or the service fulfilment relation is always between the User and the Activity Provider
        ibibo shall not provide pick up and drop facility for any Activity unless otherwise explicitly mentioned in the confirmation of the reservation.
        ibibo shall not be liable or responsible for:
        ...
        The maximum liability of ibibo will be limited to refund of booking amount which was received by ibibo for reservation of the Activity.
        RESPONSIBILITIES OF THE USERS

        The User agrees to comply with the terms and conditions of Activity Provider in addition to ibibo�s User Agreement and Terms of Service.
        The User will be required to present the booking / confirmation voucher issued by ibibo in order to avail the Activity
        ...
        ibibo may charge applicable taxes or service charge, convenience fees etc. wherever applicable. .
        SPECIAL OFFERS AND COUPONS</pre>
